...
* The [Mathematics Subject Guide](https://www.mmu.ac.uk/library/search-tools/subject-guides/mathematics){target="_blank"} on the library's website
* [finding](https://www.mmu.ac.uk/library/referencing-and-study-support/finding-information){target="_blank"} and 
* [evaluating](https://www.mmu.ac.uk/library/referencing-and-study-support/evaluating-information#t-33917-4){target="_blank"} information sources
...
* In the Arts and Humanities referencing can be a **big thing**
...
* In the Sciences
	- referencing is less of a significant issue in itself,
...
* Qian, L. (2006) 'A free-surface capturing method for two fluid flows with moving bodies', *Proceedings of the Royal Society A*, 462, pp. 21 - 42, Available at: [https://doi.org/10.1098/rspa.2005.1528](https://doi.org/10.1098/rspa.2005.1528){target="_blank"}
    - a free PDF download available from [Research Gate here](https://www.researchgate.net/profile/David-Ingram-5/publication/261144965_A_free-surface_capturing_method_for_two_fluid_flows_with_moving_bodies/links/02e7e524e82caba2ce000000/A-free-surface-capturing-method-for-two-fluid-flows-with-moving-bodies.pdf){target="_blank"}
...
* Let's see an example using the Web of Science database, found on the [Mathematics Subject Guide](https://www.mmu.ac.uk/library/search-tools/subject-guides/mathematics){target="_blank"}.